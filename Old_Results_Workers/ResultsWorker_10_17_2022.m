...
plot_yaw([1,3]+9,roll_pow_ang([1:4,6:end]),0,2.25,...
    mean_thr_new(:,[1:4,6:end]),std_error_new_thr(:,[1:4,6:end]),...
    mean_lift_new(:,[1:4,6:end]),std_error_new_lift(:,[1:4,6:end]))
